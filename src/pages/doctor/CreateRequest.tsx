...
const CreateRequest = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    localStorage.setItem("doctorRequests", JSON.stringify([newRequest, ...existing]));

    toast.success("Blood request created successfully! We're finding matching donors.");
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm opacity-90">Request blood for your patient</p>
            </div>
          </div>
        </div>
      </div>
